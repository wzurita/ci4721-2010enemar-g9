...
/*
 * $Id: longSymbol.java,v 1.1 1999/11/07 11:53:25 Paul Exp $
 *
 * The changes to this file are:
 *
 * $Log: longSymbol.java,v $
...
/**
 * Represents a symbol at runtime, with a long value.
 * @version     $Revision: 1.1 $
 * @author      Paul Pacheco
 * @since       JDK1.1
 */

public class longSymbol extends Symbol
{

		/**
		 * long value for the symbol
		 */		
		private long value;

		/**
		 * Creates a symbol with a long value
		 * @parem value the value of the symbol
		 */
		public longSymbol(long value)
		{
			this.value=value;
		}		
