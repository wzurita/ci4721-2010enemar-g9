...
/*
 * $Id: LexerException.java,v 1.1 1999/11/07 11:53:25 Paul Exp $
 *
 * the changes to this file are
 *
 * $Log: LexerException.java,v $
...
/**
 * Signals that a Lexer exception has ocurred. A lexer exception ocurrs when
 * the input is not recognized by any token in a given sintactic state
...
public class LexerException extends LanguageException
{
   ...
   */ 
  public LexerException (String msg, int line, int col, int pos)
  {
    super (msg, line, col, pos);
  }
}
